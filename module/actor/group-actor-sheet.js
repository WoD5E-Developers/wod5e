  ...
  get template () {
    ...
    switch (this.actor.system.groupType) {
      case 'cell':
        ...
        return 'systems/vtm5ec/templates/actor/cell-sheet.hbs'

      case 'coterie':
        this.options.classes.push(...['coterie-sheet'])
        return 'systems/vtm5ec/templates/actor/coterie-sheet.hbs'

      case 'pack':
        this.options.classes.push(...['werewolf-sheet'])
        return 'systems/vtm5ec/templates/actor/pack-sheet.hbs'
