...
export class WoDActor extends ActorSheet {
  ...
  async getData () {
    ...
    data.displayBanner = game.settings.get('vtm5ec', 'actorBanner')
  ...
  async _onSkillEdit (event) {
    ...
    const skillTemplate = 'systems/vtm5ec/templates/actor/parts/skill-dialog.hbs'
    // Render the template
  ...
  async _onCreateItem (event) {
    ...
    const itemImg = itemsList[type]?.img || 'systems/vtm5ec/assets/icons/items/item-default.svg'
