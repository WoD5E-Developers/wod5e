...
export class WerewolfActorSheet extends WoDActor {
  ...
  static get defaultOptions () {
    ...
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: classList,
      template: 'systems/vtm5ec/templates/actor/werewolf-sheet.hbs',
      width: 1050,
      height: 700,
      tabs: [{
  ...
  get template () {
    ...
    return 'systems/vtm5ec/templates/actor/werewolf-sheet.hbs'
  }
  ...
  _onLostTheWolf () {
    ...
    if (!game.settings.get('vtm5ec', 'automatedRage')) return
  ...
  async handleFormChange (form, diceCount) {
    ...
    if (game.settings.get('vtm5ec', 'automatedRage') && actor.system.rage.value === 0) {
