...
export const _onAddBonus = async function (event, actor, data, SkillEditDialog) {
  ...
  // Render the template
  const bonusTemplate = 'systems/vtm5ec/templates/actor/parts/specialty-display.hbs'
      ...
      buttons: {
        add: {
          ...
          callback: async html => {
            ...
            SkillEditDialog.data.content = await renderTemplate('systems/vtm5ec/templates/actor/parts/skill-dialog.hbs', {
              id: data.id,
              actor,
              system,
