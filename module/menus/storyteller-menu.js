...
export class StorytellerMenu extends FormApplication {
  static get defaultOptions () {
    return foundry.utils.mergeObject(super.defaultOptions, {
      ...
      classes: ['wod5e'],
      template: 'systems/vtm5ec/templates/ui/storyteller-menu.hbs',
      width: 500,
      height: 450,
      resizable: true,
      closeOnSubmit: true,
  ...
  activateListeners (html) {
    ...
    html.find('.add-custom-button').click(function (event) {
      ...
      if (type === 'attribute') {
        ...
        const customAttributes = game.settings.get('vtm5ec', 'customAttributes')
        ...
        game.settings.set('vtm5ec', 'customAttributes', customAttributes)
      } else if (type === 'skill') {
        // Get the list of custom skills
        const customSkills = game.settings.get('vtm5ec', 'customSkills')
        ...
        // Set the new list of attributes
        game.settings.set('vtm5ec', 'customSkills', customSkills)
      }
    })
    ...
    html.find('.save-modifications').click(function (event) {
      ...
      game.settings.set('vtm5ec', 'modifiedAttributes', attributeModifications)
      game.settings.set('vtm5ec', 'customAttributes', customAttributes)
      game.settings.set('vtm5ec', 'modifiedSkills', skillModifications)
      game.settings.set('vtm5ec', 'customSkills', customSkills)
    })
  }
}
...
async function _onRenderPromptDialog (type, list, title) {
  // Render the template
  const template = 'systems/vtm5ec/templates/ui/select-dialog.hbs'
        ...
        add: {
          ...
          callback: async html => {
            ...
            if (type === 'attribute') {
              ...
              const modifiedAttributes = game.settings.get('vtm5ec', 'modifiedAttributes')
              ...
              // Set the new list of attributes
              game.settings.set('vtm5ec', 'modifiedAttributes', modifiedAttributes)
            } else if (type === 'skill') {
              // Get the list of modified skills
              const modifiedSkills = game.settings.get('vtm5ec', 'modifiedSkills')
              ...
              game.settings.set('vtm5ec', 'modifiedSkills', modifiedSkills)
            }
          }
        },
        cancel: {
...
async function _onRemoveChange (type, id) {
  if (type === 'attribute') {
    // Get the list of modified attributes
    let modifiedAttributes = game.settings.get('vtm5ec', 'modifiedAttributes')
    ...
    // Get the list of modified skills
    let modifiedSkills = game.settings.get('vtm5ec', 'modifiedSkills')
