...
class WOD5eDice {
  ...
  static async Roll ({
    ...
    const _roll = async (inputBasicDice, inputAdvancedDice, $form) => {
      ...
      if (willpowerDamage > 0 && game.settings.get('vtm5ec', 'automatedWillpower')) _damageWillpower(actor, willpowerDamage)
    ...
    if (!quickRoll) {
      ...
      const dialogTemplate = `systems/vtm5ec/templates/ui/${system}-roll-dialog.hbs`
