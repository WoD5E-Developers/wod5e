 ...
 * @extends {WoDItem}
 */
export class GearItemSheet extends HandlebarsApplicationMixin(WoDItem) {
  ...
  static PARTS = {
    header: {
      template: 'systems/vtm5ec/display/shared/items/gear-sheet.hbs'
    },
    tabs: {
    ...
    settings: {
      template: 'systems/vtm5ec/display/shared/items/parts/gear-settings.hbs'
    }
  }
