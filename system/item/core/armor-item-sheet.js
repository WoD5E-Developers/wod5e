 ...
 * @extends {WoDItemBase}
 */
export class ArmorItemSheet extends HandlebarsApplicationMixin(WoDItemBase) {
  ...
  static PARTS = {
    header: {
      template: 'systems/wod5e/display/shared/items/armor-sheet.hbs'
    },
    tabs: {
  ...
  async _prepareContext() {
    ...
    data.armorvalue = itemData.armorvalue
