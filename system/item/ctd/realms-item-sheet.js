...
import { Realms } from '../../api/def/arts.js'
 ...
 * @extends {WoDItem}
 */
export class RealmsItemSheet extends HandlebarsApplicationMixin(WoDItem) {
  ...
  static PARTS = {
    header: {
      template: 'systems/vtm5ec/display/vtm/items/art-sheet.hbs'
    },
    tabs: {
  ...
  async _prepareContext () {
    ...
    data.realmsOptions = Realms.getList({})
    data.selectedArt = itemData.realm
